...
@Component({
  selector: 'clr-profesor-not-closable-psg-angular',
  styleUrls: ['../profesor.psg.scss'],
  templateUrl: './profesor-editar.psg.html',
})
export class ProfesorEditarFormDemo implements OnInit {
  ...
  constructor(
    ...
    this.profesorForm = this.fb.group({
      ...
      correopro: new FormControl('', Validators.required),
  ...
  editaProfesor() {
    ...
    if (this.profesorForm.invalid) {
      ...
      this.profesorService.updateEditaProfesor(this.profesorSend, this.idProfesor).subscribe(res => {
        if (res) {
