/* PSG  Monitoreochekermonerario Edita Ts */
...
@Component({
  selector: 'clr-monitoreochekermonerario-editar',
  styleUrls: ['../monitoreochekermonerario.psg.scss'],
  templateUrl: './monitoreochekermonerario-editar.psg.html',
})
export class MonitoreochekermonerarioEditarForm implements OnInit {
  public monitoreochekermonerarioForm: FormGroup;
  ...
  editaMonitoreochekermonerario() {
    ...
    if (this.monitoreochekermonerarioForm.invalid) {
      ...
      this.monitoreochekermonerarioService
        .updateEditaMonitoreochekermonerario(this.monitoreochekermonerarioSend, this.idMonitoreochekermonerario)
        .subscribe(res => {
          if (res) {
