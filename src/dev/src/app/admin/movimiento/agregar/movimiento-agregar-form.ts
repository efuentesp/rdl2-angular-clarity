...
@Component({
  selector: 'clr-movimiento-agregar',
  styleUrls: ['../movimiento.psg.scss'],
  templateUrl: './movimiento-agregar.psg.html',
})
export class MovimientoAgregarForm implements OnInit {
  ...
  ngOnInit() {
    console.log('Movimiento agregar()');
  ...
  guardaMovimiento() {
    ...
    if (this.movimientoForm.invalid) {
      ...
      this.movimientoService.postGuardaMovimiento(this.movimientoSend).subscribe(
        res => {
          if (res) {
