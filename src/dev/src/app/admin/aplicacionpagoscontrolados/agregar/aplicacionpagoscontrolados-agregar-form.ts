/* PSG  Aplicacionpagoscontrolados Agregar Ts */
...
@Component({
  selector: 'clr-aplicacionpagoscontrolados-agregar',
  styleUrls: ['../aplicacionpagoscontrolados.psg.scss'],
  templateUrl: './aplicacionpagoscontrolados-agregar.psg.html',
})
export class AplicacionpagoscontroladosAgregarForm implements OnInit {
  ...
  ngOnInit() {
    console.log('Aplicacionpagoscontrolados agregar()');
  ...
  guardaAplicacionpagoscontrolados() {
    this.submitted = true;
    ...
    if (this.aplicacionpagoscontroladosForm.invalid) {
      ...
      this.aplicacionpagoscontroladosService
        .postGuardaAplicacionpagoscontrolados(this.aplicacionpagoscontroladosSend)
        .subscribe(
          res => {
            if (res) {
