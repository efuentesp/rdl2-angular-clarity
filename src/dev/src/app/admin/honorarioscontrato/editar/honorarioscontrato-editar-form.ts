/* PSG  Honorarioscontrato Edita Ts */
...
@Component({
  selector: 'clr-honorarioscontrato-editar',
  styleUrls: ['../honorarioscontrato.psg.scss'],
  templateUrl: './honorarioscontrato-editar.psg.html',
})
export class HonorarioscontratoEditarForm implements OnInit {
  public honorarioscontratoForm: FormGroup;
  ...
  editaHonorarioscontrato() {
    ...
    if (this.honorarioscontratoForm.invalid) {
      ...
      this.honorarioscontratoService
        .updateEditaHonorarioscontrato(this.honorarioscontratoSend, this.idHonorarioscontrato)
        .subscribe(res => {
          if (res) {
