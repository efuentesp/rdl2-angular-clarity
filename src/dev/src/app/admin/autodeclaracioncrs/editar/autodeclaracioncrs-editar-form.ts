/* PSG  Autodeclaracioncrs Edita Ts */
...
@Component({
  selector: 'clr-autodeclaracioncrs-editar',
  styleUrls: ['../autodeclaracioncrs.psg.scss'],
  templateUrl: './autodeclaracioncrs-editar.psg.html',
})
export class AutodeclaracioncrsEditarForm implements OnInit {
  public autodeclaracioncrsForm: FormGroup;
  ...
  editaAutodeclaracioncrs() {
    ...
    if (this.autodeclaracioncrsForm.invalid) {
      ...
      this.autodeclaracioncrsService
        .updateEditaAutodeclaracioncrs(this.autodeclaracioncrsSend, this.idAutodeclaracioncrs)
        .subscribe(res => {
          if (res) {
