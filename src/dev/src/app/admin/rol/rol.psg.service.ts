...
export class RolService {
  ...
  getRecuperaRolPorDireccion(id) {
    ...
    let headers = new HttpHeaders().set('Authorization', 'Bearer ' + this.token);
    return this.http
      .get<any>(`${environment.apiUrl}/auth/roles?direccionId=` + id, { headers: headers })
      .pipe(map(res => res));
  }
  getRecuperaRolPorTipopension(id) {
    ...
    let headers = new HttpHeaders().set('Authorization', 'Bearer ' + this.token);
    return this.http
      .get<any>(`${environment.apiUrl}/auth/roles?tipopensionId=` + id, { headers: headers })
      .pipe(map(res => res));
  }
  getRecuperaRolPorSolicitudpension(id) {
    ...
    let headers = new HttpHeaders().set('Authorization', 'Bearer ' + this.token);
    return this.http
      .get<any>(`${environment.apiUrl}/auth/roles?solicitudpensionId=` + id, { headers: headers })
      .pipe(map(res => res));
  }
  getRecuperaRolPorBeneficiario(id) {
    ...
    let headers = new HttpHeaders().set('Authorization', 'Bearer ' + this.token);
    return this.http
      .get<any>(`${environment.apiUrl}/auth/roles?beneficiarioId=` + id, { headers: headers })
      .pipe(map(res => res));
  }
