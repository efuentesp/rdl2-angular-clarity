/* PSG  Formasliquidacion Agregar Ts */
...
@Component({
  selector: 'clr-formasliquidacion-agregar',
  styleUrls: ['../formasliquidacion.psg.scss'],
  templateUrl: './formasliquidacion-agregar.psg.html',
})
export class FormasliquidacionAgregarForm implements OnInit {
  ...
  ngOnInit() {
    console.log('Formasliquidacion agregar()');
  ...
  guardaFormasliquidacion() {
    ...
    if (this.formasliquidacionForm.invalid) {
      ...
      this.formasliquidacionService.postGuardaFormasliquidacion(this.formasliquidacionSend).subscribe(
        res => {
          if (res) {
