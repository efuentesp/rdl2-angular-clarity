...
@Component({
  selector: 'clr-aportaciones-editar',
  styleUrls: ['../aportaciones.psg.scss'],
  templateUrl: './aportaciones-editar.psg.html',
})
export class AportacionesEditarForm implements OnInit {
  public aportacionesForm: FormGroup;
  ...
  editaAportaciones() {
    ...
    if (this.aportacionesForm.invalid) {
      ...
      if (this.aportacionesForm.controls['fechacontabilizacionAux'].value !== null) {
        ...
        this.aportacionesSend.fechacontabilizacion = null;
      }
      ...
      this.aportacionesService.updateEditaAportaciones(this.aportacionesSend, this.idAportaciones).subscribe(res => {
        if (res) {
