...
export class AdminComponent {
  ...
  private customer_delete: boolean = false;
  private customer_create: boolean = false;
  private customer_read: boolean = false;
  private purchaseorder_update: boolean = false;
  private purchaseorder_delete: boolean = false;
  private purchaseorder_create: boolean = false;
  private purchaseorder_read: boolean = false;
  ...
  buildMenu() {
    this.permissions.forEach(element => {
      if (element.code == 'CUSTOMER:CREATE') {
        this.customer_create = true;
      }

      if (element.code == 'CUSTOMER:UPDATE') {
        this.customer_update = true;
      }

      if (element.code == 'CUSTOMER:DELETE') {
        this.customer_delete = true;
      }

      if (element.code == 'CUSTOMER:READ') {
        this.customer_read = true;
      }

      if (element.code == 'CUSTOMER:*') {
        this.customer_update = true;
        this.customer_create = true;
        this.customer_delete = true;
        this.customer_read = true;
      ...
      if (element.code == 'PURCHASEORDER:CREATE') {
        this.purchaseorder_create = true;
      }

      if (element.code == 'PURCHASEORDER:UPDATE') {
        this.purchaseorder_update = true;
      }

      if (element.code == 'PURCHASEORDER:DELETE') {
        this.purchaseorder_delete = true;
      }

      if (element.code == 'PURCHASEORDER:READ') {
        this.purchaseorder_read = true;
      }

      if (element.code == 'PURCHASEORDER:*') {
        this.purchaseorder_update = true;
        this.purchaseorder_create = true;
        this.purchaseorder_delete = true;
        this.purchaseorder_read = true;
