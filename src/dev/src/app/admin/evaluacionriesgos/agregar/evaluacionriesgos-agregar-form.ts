/* PSG  Evaluacionriesgos Agregar Ts */
...
@Component({
  selector: 'clr-evaluacionriesgos-agregar',
  styleUrls: ['../evaluacionriesgos.psg.scss'],
  templateUrl: './evaluacionriesgos-agregar.psg.html',
})
export class EvaluacionriesgosAgregarForm implements OnInit {
  ...
  ngOnInit() {
    console.log('Evaluacionriesgos agregar()');
  ...
  guardaEvaluacionriesgos() {
    ...
    if (this.evaluacionriesgosForm.invalid) {
      ...
      this.evaluacionriesgosService.postGuardaEvaluacionriesgos(this.evaluacionriesgosSend).subscribe(
        res => {
          if (res) {
