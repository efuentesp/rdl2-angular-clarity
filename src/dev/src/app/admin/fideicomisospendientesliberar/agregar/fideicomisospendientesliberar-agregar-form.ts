/* PSG  Fideicomisospendientesliberar Agregar Ts */
...
@Component({
  selector: 'clr-fideicomisospendientesliberar-agregar',
  styleUrls: ['../fideicomisospendientesliberar.psg.scss'],
  templateUrl: './fideicomisospendientesliberar-agregar.psg.html',
})
export class FideicomisospendientesliberarAgregarForm implements OnInit {
  ...
  ngOnInit() {
    console.log('Fideicomisospendientesliberar agregar()');
  ...
  guardaFideicomisospendientesliberar() {
    this.submitted = true;
    ...
    if (this.fideicomisospendientesliberarForm.invalid) {
      ...
      this.fideicomisospendientesliberarService
        .postGuardaFideicomisospendientesliberar(this.fideicomisospendientesliberarSend)
        .subscribe(
          res => {
            if (res) {
