/* PSG  Fideicomisospendientesliberar Edita Ts */
...
import { FideicomisospendientesliberarSend } from '../fideicomisospendientesliberar.psg.model-send';
...
@Component({
  selector: 'clr-fideicomisospendientesliberar-editar',
  styleUrls: ['../fideicomisospendientesliberar.psg.scss'],
  templateUrl: './fideicomisospendientesliberar-editar.psg.html',
})
export class FideicomisospendientesliberarEditarForm implements OnInit {
  public fideicomisospendientesliberarForm: FormGroup;
  public submitted = false;
  public loading = false;
  public fideicomisospendientesliberar: Fideicomisospendientesliberar = new Fideicomisospendientesliberar();
  public fideicomisospendientesliberarSend: FideicomisospendientesliberarSend = new FideicomisospendientesliberarSend();
  ...
  constructor(
    ...
    this.fideicomisospendientesliberarForm = this.fb.group({
      ...
      nombrefiso: new FormControl('', Validators.required),
      tiponegocio: new FormControl('', Validators.required),
      clasifproducto: new FormControl('', Validators.required),
  ...
  editaFideicomisospendientesliberar() {
    this.submitted = true;

    if (this.fideicomisospendientesliberarForm.invalid) {
      swal('Error...', 'Fideicomisos Pendientes de Liberar has fields to fill.', 'error');
    } else {
      this.route.params.subscribe(params => {
        this.idFideicomisospendientesliberar = params['id'];
      });

      this.fideicomisospendientesliberarSend.fideicomisoId = this.fideicomisospendientesliberarForm.controls[
        'fideicomisoId'
      ].value;
      this.fideicomisospendientesliberarSend.nombrefiso = this.fideicomisospendientesliberarForm.controls[
        'nombrefiso'
      ].value;
      this.fideicomisospendientesliberarSend.tiponegocio = this.fideicomisospendientesliberarForm.controls[
        'tiponegocio'
      ].value;
      this.fideicomisospendientesliberarSend.clasifproducto = this.fideicomisospendientesliberarForm.controls[
        'clasifproducto'
      ].value;
      this.fideicomisospendientesliberarSend.manejo = this.fideicomisospendientesliberarForm.controls['manejo'].value;
      this.fideicomisospendientesliberarSend.tipopersona = this.fideicomisospendientesliberarForm.controls[
        'tipopersona'
      ].value;
      this.fideicomisospendientesliberarSend.estatus = this.fideicomisospendientesliberarForm.controls['estatus'].value;

      this.fideicomisospendientesliberarService
        .updateEditaFideicomisospendientesliberar(
          this.fideicomisospendientesliberarSend,
          this.idFideicomisospendientesliberar
        )
        .subscribe(res => {
          if (res) {
            if (res.status === 201 || res.status === 200) {
              swal('Success...', 'Fideicomisos Pendientes de Liberar save successfully.', 'success');
              this.location.back();
            } else {
              swal('Error...', 'Fideicomisos Pendientes de Liberar has fields to fill.', 'error');
            }
  ...
  setClickedRowFideicomiso(index, fideicomiso) {
    ...
    if (fideicomiso.checked) {
      ...
      this.fideicomisospendientesliberarForm.controls['fideicomisoId'].setValue(fideicomiso.id);
      this.fideicomisospendientesliberarForm.controls['fideicomisoItem'].setValue(fideicomiso.generalesnumero);
    } else {
      this.fideicomisoService.clear();
      this.fideicomisospendientesliberarForm.controls['fideicomisoId'].setValue(null);
      this.fideicomisospendientesliberarForm.controls['fideicomisoItem'].setValue('');
    }
  }
