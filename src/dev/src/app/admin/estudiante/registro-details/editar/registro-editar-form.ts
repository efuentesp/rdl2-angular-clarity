...
export class RegistroDetailsEditarFormDemo implements OnInit {
    ...
    if (this.registroForm.invalid) {
      ...
      this.registroService.updateEditaRegistro(this.registroSend, this.idRegistro).subscribe(res => {
        if (res) {
          ...
          // DETAILS this.router.navigate(['../../../registro-details/administrar/', this.registroSend.estudianteId], { relativeTo: this.route });
        } else {
  ...
  regresaRegistro() {
    // DETAILS this.router.navigate(['../../../registro-details/administrar/', this.idEstudiante], { relativeTo: this.route });
  }
}
