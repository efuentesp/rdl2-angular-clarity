/* PSG  Documentosfideicomiso Agregar Ts */
...
@Component({
  selector: 'clr-documentosfideicomiso-agregar',
  styleUrls: ['../documentosfideicomiso.psg.scss'],
  templateUrl: './documentosfideicomiso-agregar.psg.html',
})
export class DocumentosfideicomisoAgregarForm implements OnInit {
  ...
  ngOnInit() {
    console.log('Documentosfideicomiso agregar()');
  ...
  guardaDocumentosfideicomiso() {
    ...
    if (this.documentosfideicomisoForm.invalid) {
      ...
      this.documentosfideicomisoService.postGuardaDocumentosfideicomiso(this.documentosfideicomisoSend).subscribe(
        res => {
          if (res) {
