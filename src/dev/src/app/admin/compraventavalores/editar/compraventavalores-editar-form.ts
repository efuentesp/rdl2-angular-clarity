/* PSG  Compraventavalores Edita Ts */
...
@Component({
  selector: 'clr-compraventavalores-editar',
  styleUrls: ['../compraventavalores.psg.scss'],
  templateUrl: './compraventavalores-editar.psg.html',
})
export class CompraventavaloresEditarForm implements OnInit {
  public compraventavaloresForm: FormGroup;
  ...
  editaCompraventavalores() {
    ...
    if (this.compraventavaloresForm.invalid) {
      ...
      if (this.compraventavaloresForm.controls['fechaoperacionAux'].value !== null) {
        ...
        this.compraventavaloresSend.fechaoperacion = null;
      }
      ...
      this.compraventavaloresService
        .updateEditaCompraventavalores(this.compraventavaloresSend, this.idCompraventavalores)
        .subscribe(res => {
          if (res) {
