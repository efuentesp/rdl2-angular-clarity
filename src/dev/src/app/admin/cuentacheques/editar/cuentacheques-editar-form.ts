...
@Component({
  selector: 'clr-cuentacheques-editar',
  styleUrls: ['../cuentacheques.psg.scss'],
  templateUrl: './cuentacheques-editar.psg.html',
})
export class CuentachequesEditarForm implements OnInit {
  public cuentachequesForm: FormGroup;
  ...
  editaCuentacheques() {
    ...
    if (this.cuentachequesForm.invalid) {
      ...
      this.cuentachequesService
        .updateEditaCuentacheques(this.cuentachequesSend, this.idCuentacheques)
        .subscribe(res => {
          if (res) {
