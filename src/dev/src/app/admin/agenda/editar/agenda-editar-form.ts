...
@Component({
  selector: 'clr-agenda-editar',
  styleUrls: ['../agenda.psg.scss'],
  templateUrl: './agenda-editar.psg.html',
})
export class AgendaEditarForm implements OnInit {
  ...
  editaAgenda() {
    ...
    if (this.agendaForm.invalid) {
      ...
      this.agendaService.updateEditaAgenda(this.agendaSend, this.idAgenda).subscribe(res => {
        if (res) {
