...
export class ValidationService {
  ...
  static emailValidator(control) {
    console.log('errorMessage() ControlMessagesComponent');
  ...
  static passwordValidator(control) {
    console.log('passwordValidator() ControlMessagesComponent');
  ...
  static onlyNumbers(control) {
    console.log('onlyNumbers() ControlMessagesComponent');
  ...
  static numberMinor(control) {
    console.log('numberMinor() ControlMessagesComponent');
  ...
  static selectValidator(control) {
    console.log('selectValidator() ControlMessagesComponent');
    if (control.value != -1) {
      return null;
    } else {
  ...
  static countrySelectValidator(control) {
    console.log('countrySelectValidator() ControlMessagesComponent');
    if (control.value != -1) {
      return null;
    } else {
      return { invalidSelectValue: true };
  ...
  static checkValidator(control) {
    console.log('checkValidator() ControlMessagesComponent');
    if (control.value) {
      return null;
    } else {
